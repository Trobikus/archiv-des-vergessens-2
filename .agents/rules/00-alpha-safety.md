...
5. **Gate before done.** Meaningful code changes are unfinished until relevant checks pass (`npm run typecheck`, `lint`, targeted tests; full `npm run gate` for release-risk areas).
