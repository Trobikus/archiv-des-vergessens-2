...
Die veröffentlichte Produktversion ist **`0.3.5-alpha`**. Dokumente mit der Bezeichnung „2.0.0“ beschreiben den Rewrite-Meilenstein (Feature-Parität / Cutover), nicht zwingend die aktuelle GitHub-Release-Nummer.
...
**Produktstatus danach:** frühe Alpha (`0.3.5-alpha`) — Playtest, Feinschliff, Inhalte.
